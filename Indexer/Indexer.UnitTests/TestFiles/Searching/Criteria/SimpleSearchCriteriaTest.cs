...
namespace Sando.Indexer.UnitTests.Searching.Criteria
{
	...
	public class SimpleSearchCriteriaTest
	{
		...
		public void SimpleSearchCriteria_ToQueryStringCreatesValidUsageTypesQueryString_NoCondition()
		{
			...
			string queryString = simpleSearchCriteria.ToQueryString();
            string actual = "(" + SandoField.Body.ToString() + ":SimpleClass OR " + SandoField.Name.ToString() + ":SimpleClass^3 OR " + SandoField.ExtendedClasses.ToString() + ":SimpleClass^0.5 OR " + SandoField.ImplementedInterfaces.ToString() + ":SimpleClass^0.5 OR " + SandoField.Arguments.ToString() + ":SimpleClass^0.25 OR " + SandoField.ReturnType.ToString() + ":SimpleClass^0.25 OR " + SandoField.Namespace.ToString() + ":SimpleClass^0.25 OR " + SandoField.DataType.ToString() + ":SimpleClass OR " + SandoField.Source.ToString() + ":SimpleClass OR " + SandoField.ClassName.ToString() + ":SimpleClass)";
		...
		public void SimpleSearchCriteria_ToQueryStringCreatesValidUsageTypesQueryString_MultipleConditions()
		{
			...
			string queryString = simpleSearchCriteria.ToQueryString();
            Assert.AreEqual(queryString, "(" + SandoField.Name.ToString() + ":SimpleClass^3 OR " + SandoField.ExtendedClasses.ToString() + ":SimpleClass^0.5 OR " + SandoField.Namespace.ToString() + ":SimpleClass^0.25)", "Created query string is invalid!");
			try
			{
				Query query = new QueryParser(Lucene.Net.Util.Version.LUCENE_29, SandoField.Name.ToString(), new SimpleAnalyzer()).Parse(queryString);
				Assert.NotNull(query, "Generated query object is null!");
		...
		public void SimpleSearchCriteria_ToQueryStringCreatesValidUsageTypesQueryString_MultipleSearchTerms()
		{
			...
			string queryString = simpleSearchCriteria.ToQueryString();
            string actual = "(" + SandoField.Name.ToString() + ":Class^3 OR " + SandoField.ExtendedClasses.ToString() + ":Class^0.5 OR " + SandoField.Namespace.ToString() + ":Class^0.25 OR " + "" + SandoField.Name.ToString() + ":Simple^3 OR " +
                SandoField.ExtendedClasses.ToString() + ":Simple^0.5 OR " + SandoField.Namespace.ToString() + ":Simple^0.25)";
		    Assert.AreEqual(queryString, actual, "Created query string is invalid!");
			try
			{
				Query query = new QueryParser(Lucene.Net.Util.Version.LUCENE_29, SandoField.Name.ToString(), new SimpleAnalyzer()).Parse(queryString);
		...
		public void SimpleSearchCriteria_ToQueryStringCreatesValidQueryString_AllConditions()
		{
			...
			Assert.AreEqual(queryString, "(" + SandoField.AccessLevel.ToString() + ":protected OR " + SandoField.AccessLevel.ToString() + ":public) AND " +
                                        ...
                                        "(" + SandoField.Name.ToString() + ":SimpleClass^3 OR " + SandoField.ExtendedClasses.ToString() + ":SimpleClass^0.5 OR " + SandoField.Namespace.ToString() + ":SimpleClass^0.25)", "Created query string is invalid!");
			try
			{
				Query query = new QueryParser(Lucene.Net.Util.Version.LUCENE_29, SandoField.Name.ToString(), new SimpleAnalyzer()).Parse(queryString);
				Assert.NotNull(query, "Generated query object is null!");
