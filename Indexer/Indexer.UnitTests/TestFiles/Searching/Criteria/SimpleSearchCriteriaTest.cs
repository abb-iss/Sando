...
namespace Sando.Indexer.UnitTests.Searching.Criteria
{
	...
	public class SimpleSearchCriteriaTest
	{
		...
		public void SimpleSearchCriteria_ToQueryStringCreatesValidUsageTypesQueryString_NoCondition()
		{
			...
			string queryString = simpleSearchCriteria.ToQueryString();
		    string actual = "(" + SandoField.Body.ToString() + ":SimpleClass OR " + SandoField.Name.ToString() + ":SimpleClass^4 OR " + SandoField.ExtendedClasses.ToString() + ":SimpleClass OR " + SandoField.ImplementedInterfaces.ToString() + ":SimpleClass OR " + SandoField.Arguments.ToString() + ":SimpleClass OR " + SandoField.ReturnType.ToString() + ":SimpleClass OR " + SandoField.Namespace.ToString() + ":SimpleClass OR " + SandoField.DataType.ToString() + ":SimpleClass)";
