...
namespace Sando.Indexer.Documents
{
	public class ClassDocument : SandoDocument
	{
        ...
        public override ProgramElement ReadProgramElementFromDocument(string name, ProgramElementType programElementType, string fullFilePath, int definitionLineNumber, string snippet, Document document)
		{
            ...
            return base.ReadProgramElementFromDocument(GetMyType(document), new object[]{name, definitionLineNumber, fullFilePath, snippet, accessLevel, namespaceName, extendedClasses, implementedInterfaces, modifiers, ""},document);
		}
	}
}
