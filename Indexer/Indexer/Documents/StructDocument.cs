...
namespace Sando.Indexer.Documents
{
    public class StructDocument : SandoDocument
    {
        ...
        public override void AddDocumentFields(Document luceneDocument)
        {
            ...
            luceneDocument.Add(new Field(SandoField.Body.ToString(), structElement.Body.ToSandoSearchable(), Field.Store.NO, Field.Index.ANALYZED));
            luceneDocument.Add(new Field(SandoField.AccessLevel.ToString(), structElement.AccessLevel.ToString().ToLower(), Field.Store.YES, Field.Index.NOT_ANALYZED));
            luceneDocument.Add(new Field(SandoField.ExtendedClasses.ToString(), structElement.ExtendedStructs.ToSandoSearchable(), Field.Store.YES, Field.Index.ANALYZED));
