...
namespace Sando.IntegrationTests.Search
{
	...
	public class StemmingSearchTest
	{
		...
		public void SearchIsUsingStemming()
		{
			...
			//Assert.AreEqual(methodElement.DefinitionLineNumber, 15, "Method definition line number differs!");
			...
			//Assert.True(methodElement.ClassId != null && methodElement.ClassId != Guid.Empty, "Class id is invalid!");
			//Assert.AreEqual(methodElement.ClassName, "FileNameTemplate", "Method class name differs!");
			//Assert.AreEqual(methodElement.DefinitionLineNumber, 51, "Method definition line number differs!");
			//Assert.True(methodElement.FullFilePath.EndsWith("\\TestFiles\\StemmingTestFiles\\FileNameTemplate.cs"), "Method full file path is invalid!");
			...
			//var fieldSearchResult = codeSearchResults.Find(el => el.Element.ProgramElementType == ProgramElementType.Method && el.Element.Name == "TryAddTemplatePrompt");
			//if(fieldSearchResult == null)
			//{
			//    Assert.Fail("Failed to find relevant search result for search: " + keywords);
			//}
			//var fieldElement = fieldSearchResult.Element as FieldElement;
			//Assert.AreEqual(fieldElement.AccessLevel, AccessLevel.Public, "Field access level differs!");
			...
			//Assert.AreEqual(fieldElement.DefinitionLineNumber, 51, "Field definition line number differs!");
			...
			//Assert.AreEqual(fieldElement.Name, "TryAddTemplatePrompt", "Field name differs!");
			//Assert.AreEqual(fieldElement.ProgramElementType, ProgramElementType.Method, "Program element type differs!");
