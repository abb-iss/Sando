...
{
    class FieldElementWithRelation : ProgramElementWithRelation
    {
        public FieldElementWithRelation(string name, int definitionLineNumber, string fullFilePath, 
            string snippet, ProgramElementRelation elementralation, AccessLevel accessLevel,
			string fieldType, Guid classId, string className, string modifiers, string initialValue) 
			: base(name, definitionLineNumber, fullFilePath, snippet, elementralation)
		{
